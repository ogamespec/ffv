...
C4:0000 - загрузка программы [SPC](SPC.md). Там же рядом находится куча кода, скорее всего ответственного за воспроизведение музыки и звуковых эффектов.

C0:44C8 - BackgroundFX. Используется также для начальной заставки и финальных титров. [intro](intro.md)

C0:490A - [fill](fill.md)

C2:A000 - [GameMenu](GameMenu.md)

C0:A217 - CutScene aka [GameLoop](GameLoop.md). игровой сценарий (различные сюжетные сценки)

[SomeInitC0](SomeInitC0.md) -- инициализация всяких массивов перед запуском игры.
